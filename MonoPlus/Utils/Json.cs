...
public static class Json
{
    ...
    /// </summary>
    public static JsonSerializerOptions Common = new() { AllowTrailingCommas = true};

    /// <summary>
    /// <see cref="Common"/> for cases when you want to write clean and readable JSON.
    /// </summary>
    public static JsonSerializerOptions Readable = new(Common) { WriteIndented = true, RespectNullableAnnotations = true};

    /// <summary>
    /// <see cref="Readable"/>, but includes serializing and deserializing fields.
    /// </summary>
    public static JsonSerializerOptions WithFields = new(Readable) { IncludeFields = true };
}
